'''
    ...
    2. read data
'''
from config_iso_IBADAN_k8 import general_configuration as gen_conf
from config_iso_IBADAN_k8 import training_configuration as train_conf
from config_iso_IBADAN_k8 import testing_configuration as test_conf
