'''
    ...
    2. read data
'''
from config_typeB_IBADAN import general_configuration as gen_conf
from config_typeB_IBADAN import training_configuration as train_conf
from config_typeB_IBADAN import testing_configuration as test_conf
