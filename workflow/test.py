...
def testing(gen_conf, test_conf, train_conf = None) :
    ...
    if train_conf == None:
        ...
        model = read_model(gen_conf, train_conf, 1)
    print("Test model ...")
    ## test and save output
    test_model_3(gen_conf, test_conf, input_data, model, mean, std)  # comment cauz' debugging
